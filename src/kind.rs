...
pub const fn make_kind_impl<const BASE_COUNT: usize>(id: u8, bases: [KindValue; BASE_COUNT]) -> KindValue {
...
pub const DEEP_HISTORY: KindValue = PSEUDOSTATE; // Alias for compatibility
